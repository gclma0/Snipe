...
APPLICATION_MATERIALS_CONTEXT_VERSION = "ai-application-materials-context-v1"


def build_application_materials_context(
    *,
    ...
    return {
        "context_version": APPLICATION_MATERIALS_CONTEXT_VERSION,
        ...
        "constraints": [
            ...
            (
                "Draft application materials with candidate-review placeholders where details "
                "are missing."
            ),
            "Do not invent achievements, metrics, skills, employers, credentials, or experience.",
            "Warn when requested wording needs evidence missing from the profile.",
        ],
    }


def application_materials_context_hash(context: dict[str, Any]) -> str:
