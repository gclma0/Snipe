...
def build_project_roadmap_context(
    *,
    ...
    return {
        "context_version": ROADMAP_CONTEXT_VERSION,
        ...
        "constraints": [
            ...
            "Recommend realistic projects and roadmap steps; do not claim they are completed.",
            "Warn when a project or roadmap item needs evidence missing from the profile.",
