...
- Usage summaries aggregate counts by event name and surface only. They do not return event rows, anonymous session IDs, metadata payloads, user IDs, profile IDs, or source URLs.
